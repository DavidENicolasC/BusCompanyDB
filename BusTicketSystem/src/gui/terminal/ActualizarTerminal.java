 ...
 * @author David
 */
public class ActualizarTerminal extends javax.swing.JFrame {
    Object estados[][];
    Object gerentes[][];
    Object term[];
    Object dir[];
    ...
    int idAutobus;
    /**
     * Creates new form ActualizarTerminal
     */
    public ActualizarTerminal() {
        initComponents();
    }
    
    public ActualizarTerminal(int id) {
        initComponents();
        idAutobus = id;
        estado = new Estado();
        ...
        term = new Object[4];
        term = terminal.selectTerminal(id);
        dir = new Object[9];
        dir = direccion.selectDireccion(Integer.parseInt(term[2].toString()));
        
        llenaEstados();
        llenaGerentes();
        NombreCampo.setText(term[1].toString());
        ListaEstados.setSelectedIndex(Integer.parseInt(dir[8].toString()) - 1);
        ListaGerentes.setSelectedIndex(gersel);
        CampoMunicipio.setText(dir[1].toString());
        CampoColonia.setText(dir[2].toString());
        CampoCodigoPostal.setText(dir[3].toString());
        CampoCalle.setText(dir[4].toString());
        CampoNumero.setText(dir[5].toString());
        CampoTelefono.setText(dir[6].toString());
        CampoCorreo.setText(dir[7].toString());
    }
    ...
    private void llenaGerentes(){
        ...
        for (Object[] e : gerentes) {
            ...
            if(Integer.parseInt(e[6].toString()) == 2)
            {
                ...
                if( Integer.parseInt(e[0].toString()) == Integer.parseInt(term[3].toString()) )
                    gersel = i;
                i++;
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ACTUALIZAR TERMINAL");

        BotonCrear.setText("ACTUALIZAR TERMINAL");
        ...
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AdminEstadoActionPerformed(evt);
            }
        });
    ...
    private void BotonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonActualizarActionPerformed
        if( camposLlenos() ) {
            ...
            term[2] = Integer.parseInt(dir[0].toString());  //DIRECCION_ID
            int i = -1;
            for(int k = 0; k < gerentes.length; k++)
            {
                if(Integer.parseInt(gerentes[k][6].toString()) == 2)
                {
                    i++;
                    if(i == ListaGerentes.getSelectedIndex())
                    {
                        term[3] = gerentes[k][0];   //GERENTE_ID
                        break;
                    }
                }
            }
            int r;
            r = terminal.updateTerminal(term);
            if( r > 0 )
            {
                ...
                r = direccion.updateDireccion(dir);
                if( r > 0 )
                    javax.swing.JOptionPane.showMessageDialog(this, "Terminal y direccion actualizadas.","Aviso",2);
                else
                    javax.swing.JOptionPane.showMessageDialog(this, "Error al intentar actualizar la direccion.","Aviso",2);
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "Error al intentar actualizar la terminal.","Aviso",2);
            }
        }
    ...
    private void AdminEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdminEstadoActionPerformed
        AdminEstado aE = new AdminEstado();
        aE.setVisible(true);
        dispose();
    }//GEN-LAST:event_AdminEstadoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarTerminal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarTerminal().setVisible(true);
            }
        });
    }
